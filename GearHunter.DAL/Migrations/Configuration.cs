    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GearHunter.DAL.GearHunterDbContext>
    {
        ...
        protected override void Seed(GearHunterDbContext context)
        {
            ...
            context.Advertisements.AddOrUpdate(x => x.Id,
                new Advertisement("Smart guitar1", "Maerke1", "Model1", 1, "D1", "A1", "9000", "Aalborg", true, true, true, DateTime.Now, null, categoryGuitar),
                new Advertisement("Lang guitar2", "Maerke2", "Model2", 1, "D2", "A2", "9200", "Aalborg", true, true, true, DateTime.Now, null, categoryGuitar),
                new Advertisement("Lille bass3", "Maerke3", "Model3", 1, "D3", "A3", "9440", "Aalborg", true, true, true, DateTime.Now, null, categoryBass),
                new Advertisement("Stor bass4", "Maerke4", "Model4", 1, "D4", "A4", "9000", "Aalborg", true, true, true, DateTime.Now, null, categoryBass),
                new Advertisement("Dyrt Klaver5", "Maerke5", "Model5", 1, "D5", "A5", "9200", "Aalborg", true, true, true, DateTime.Now, null, categoryKlaver),
                new Advertisement("Billigt Klaver6", "Maerke6", "Model6", 1, "D6", "A6", "9440", "Aalborg", true, true, true, DateTime.Now, null, categoryKlaver),
                new Advertisement("Langt Keyboard7", "Maerke7", "Model7", 1, "D7", "A7", "9000", "Aalborg", true, true, true, DateTime.Now, null, categoryKlaver),
                new Advertisement("Kort Keyboard8", "Maerke8", "Model8", 1, "D8", "A8", "9200", "Aalborg", true, true, true, DateTime.Now, null, categoryKlaver),
                new Advertisement("Tromme stikker", "Maerke9", "Model9", 1, "D9", "A9", "9400", "Aalborg", true, true, true, DateTime.Now, null, categoryTilbehoer)
                );
            ...
            context.Companies.AddOrUpdate(x => x.Id,
                new Company("Musik Udlejning Aps", "DenDerVej 6", "9400", "Noerresundby", "MU@fakemail.dk", "password5", "11111111", false, true, "MusikUdlejningCVR"),
                new Company("MejeLarm IVS", "DenDerVej 7", "9400", "Noerresundby", "ML@fakemail.dk", "password5", "22222222", false, true, "MejeLarmCVR"),
                new Company("Musik Lageret Aps", "DenDerVej 8", "9400", "Noerresundby", "ML@fakemail.dk", "password5", "33333333", false, true, "MusikLageretCVR")
                );
